                ...
                <div className="max-w-7xl snap-x w-full flex justify-between items-center px-4 sm:px-6 lg:px-8 mx-auto">
                    <div className='flex'>
                        ...
                        <div className="snap-center shrink-0 pr-2 sm:pr-4 md:pr-8 text-gray-700 hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-500">
                            ...
                            <Link activeClassName='bg-clip-text bg-gradient-to-l from-pink-600 to-indigo-500 text-transparent dark:from-pink-500 dark:to-blue-500' className="inline-flex items-center" to="/experiences">Encounters</Link>
                        </div>
                        <div className="snap-center shrink-0 pr-2 sm:pr-4 md:pr-8 text-gray-700 hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-500">

                            <Link activeClassName='bg-clip-text bg-gradient-to-l from-yellow-600 to-pink-600 text-transparent dark:from-yellow-400 dark:to-pink-500' className="inline-flex items-center" to="/blog/nocturnal">Blog</Link>
                        </div>
